...
pub fn swap_base_out_process<'info>(
    ...
    raydium_amm_cpi::swap_base_out(cpi_ctx, max_amount_in, amount_out)?;
    ...
    if is_increase_coin {
        ...
        bank_account.withdraw(coin_amount_delta)?;
